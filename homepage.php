  ...
  <body>
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <a href="#" class="navbar-brand"> <img src="images/app.png" alt=""> </a>
            ...
            <ul class="navbar-nav">
              ...
              echo"<li class='nav-item'> <a href='account.php' class='nav-link'>Account</a> </li>
                  ...
                  $id = $_SESSION['id'];
                  if (isset($_SESSION['id'])) {
                    echo "Bonjour, utilisateur #" . $_SESSION['id'];
                } else {
                    echo "Bienvenue, visiteur ! Veuillez vous connecter <a href='login.php'>ici</a>.";
                }
                  ...
                  if ($rel2) {
                    // Utilisez $rel2 normalement
                    // Par exemple, vous pouvez accéder à ses clés comme ceci :
                    echo "Le nom du film est : " . $rel2['name'];
                } else {
                    // Gérer le cas où $rel2 est null (aucun résultat trouvé)
                    // Par exemple, afficher un message indiquant qu'aucun film n'a été trouvé
                    echo "Aucun film n'a été trouvé.";
                }
