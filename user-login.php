    ...
    <header>
      <div class="container-fluid">
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <a href="login.php" class="navbar-brand"> <img src="images/app.png" alt=""> </a>
        ...
        <div class="container">
          ...
          <div class="jumbotron">
            ...
            <form class="" action="Plogin.php" method="POST"> <br><br>
              ...
              <br>
              <input type="password" class="form-control" placeholder="Password (Minimum 8 characters)" name="pass" value="">
              <br><br>
